...
const apps = [
  {
    ...
    description: "Main hub dashboard — the central command center for the entire GlowStar Labs ecosystem of apps and services.",
    icon: BarChart3,
    status: "Migrating — Coming Soon",
    tags: ["Dashboard", "Hub", "Management"],
    liveUrl: "#",
  },
  {
    name: "PawfectPetsitt.ing",
    ...
    liveUrl: "https://pawfectpetsitt.ing",
    dividerBefore: true,
  },
  {
    name: "TheAltText",
  ...
  {
    name: "Reese Reviews",
    description: "Amazon review aggregation and management platform for tracking and displaying customer reviews across multiple services.",
    icon: Star,
    status: "Live",
    tags: ["Reviews", "Management", "Amazon"],
    liveUrl: "https://reese-reviews-uniwo.ondigitalocean.app",
  },
  {
  ...
  },
  {
    ...
    liveUrl: "https://mindmappr-qarz8.ondigitalocean.app/mindmappr/",
  },
  {
    name: "DataScope",
    description: "AI-powered data insights platform for intelligent analysis, pattern recognition, and actionable business intelligence.",
    icon: Eye,
    status: "Live",
    tags: ["AI", "Data", "Analytics"],
    liveUrl: "http://68.183.29.25",
  },
  {
    name: "Marketing Automation",
    description: "Social media automation platform for scheduling, publishing, and managing marketing campaigns across multiple channels.",
    icon: Zap,
    status: "Live",
    tags: ["Marketing", "Automation", "Social Media"],
    liveUrl: "http://159.65.231.36",
  },
  {
    name: "Project Face",
    description: "AI-powered facial recognition application using computer vision to provide personalized insights and recommendations.",
    icon: Sparkles,
    status: "Live",
  ...
  },
  {
    ...
    description: "Multi-source data routing platform that intelligently routes, categorizes, and manages data across different platforms and formats.",
    icon: Router,
    status: "Live",
    tags: ["Data", "Routing", "Platform"],
